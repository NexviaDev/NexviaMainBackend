 ...
 * Floating keys use an all-zero machine prefix.
 */
...
/** v2 floating: year byte + 5 zero machine bytes */
...
/**
 * Issue a floating (online) key. Always format v2 so product_year is in the code.
